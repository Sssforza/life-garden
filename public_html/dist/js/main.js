...
/* harmony import */ var nouislider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_blocks_detail_js__WEBPACK_IMPORTED_MODULE_10__["openImage"])(); // slick slider About page
  ...
  Object(_blocks_newspaper_js__WEBPACK_IMPORTED_MODULE_17__["pdfLoader"])(); // magnificPopup

  Object(_blocks_header_js__WEBPACK_IMPORTED_MODULE_4__["magnificPopup"])(); // articles

  Object(_blocks_articles_js__WEBPACK_IMPORTED_MODULE_18__["articles"])(); // check categories in news

  Object(_blocks_news_js__WEBPACK_IMPORTED_MODULE_19__["newsCategories"])();
});
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "magnificPopup", function() { return magnificPopup; });
...
function authorization() {
  if (document.querySelector(".headerTop__authorization_js")) {
    var authorizationBtn = document.querySelector(".headerTop__authorization_js");
    var enterBtnPopup = document.querySelector(".enter__btn_js");
    var regBtnPopup = document.querySelector(".reg__btn_js");
    var personalWrapper = document.querySelector(".personal_js");
    var authorizationWrapper = document.querySelector(".authorization_js");
    var authorizationPopup = authorizationWrapper.querySelector(".authorization__popup_js");
    var authorizationClose = authorizationWrapper.querySelector(".authorization__close_js");
    var forgotWindowBtn = document.querySelector(".authorization__forgot_js");
    var forgotWrapper = document.querySelector(".forgotPassword_js");

    forgotWindowBtn.onclick = function () {
      authorizationWrapper.classList.add("hidden");
      forgotWrapper.classList.remove("hidden");
    };

    authorizationBtn.onclick = function () {
      authorizationWrapper.classList.remove("hidden");
      document.body.classList.add("hiddenHeaderCatalog");
    };

    authorizationWrapper.onclick = function (e) {
      if (authorizationPopup && e.target !== authorizationPopup && !authorizationPopup.contains(e.target)) {
        authorizationWrapper.classList.add("hidden");
        document.body.classList.remove("hiddenHeaderCatalog");
      }
    };
    ...
    enterBtnPopup.onclick = function () {
      authorizationWrapper.classList.add("hidden");
      document.body.classList.remove("hiddenHeaderCatalog");
    };

    regBtnPopup.onclick = function (e) {
      e.preventDefault();
      authorizationWrapper.classList.add("hidden");
...
function forgotPassword() {
  if (document.querySelector(".clubCard__btn_js")) {
    var forgotWindowBtn = document.querySelector(".authorization__forgot_js");
    var forgotWrapper = document.querySelector(".forgotPassword_js");
    var forgotPopup = forgotWrapper.querySelector(".forgotPassword__popup_js");
    var forgotClose = forgotWrapper.querySelector(".forgotPassword__close_js");
    var forgotBtn = forgotWrapper.querySelector(".forgotPassword__btn_js");
    var rememberBtn = forgotWrapper.querySelector(".forgotPassword__remember_js");

    forgotWrapper.onclick = function (e) {
      if (forgotPopup && e.target !== forgotPopup && !forgotPopup.contains(e.target)) {
...
function personal() {
  if (document.querySelector(".reg__btn_js")) {
    var personalWrapper = document.querySelector(".personal_js");
    var personalPopup = personalWrapper.querySelector(".personal__popup_js");
    var personalClose = personalWrapper.querySelector(".personal__close_js");
    var personalBtn = personalWrapper.querySelector(".personal__btn_js");
    var personalSkipBtn = personalWrapper.querySelector(".personal__skip_js");

    personalWrapper.onclick = function (e) {
      if (personalPopup && e.target !== personalPopup && !personalPopup.contains(e.target)) {
        personalWrapper.classList.add("hidden");
        document.body.classList.remove("hiddenHeaderCatalog");
      }
    };

    personalClose.onclick = function () {
      personalWrapper.classList.add("hidden");
      document.body.classList.remove("hiddenHeaderCatalog");
    };
    ...
    personalSkipBtn.onclick = function () {
      personalWrapper.classList.add("hidden");
      document.body.classList.remove("hiddenHeaderCatalog");
    };
  }
...
function catalogPopups() {
  if (document.querySelector(".catalogCardsPopularLink_js")) {
    var closePopapPopular = function closePopapPopular(e) {
    ...
    var closePopapAlph = function closePopapAlph(e) {
    ...
    var arrowChange = function arrowChange() {
    ...
    var btnPopular = document.querySelector(".catalogCardsPopularLink_js");
    var popularItem = document.querySelectorAll(".catalogCardsPopularItem_js");
    var popupPopular = document.querySelector(".catalogCardsPopularPopup_js");
    var btnText = document.querySelector(".catalogCardsPopularLinkText_js");
    var label = document.querySelectorAll(".catalogCardsPopularLabel_js");
    ...
    var btnAlphabet = document.querySelector(".catalogCardsAlphabetLink_js");
    var popupAlphabet = document.querySelector(".catalogCardsAlphabetPopup_js");
    var letter = document.querySelectorAll(".catalogCardsAlphabetLetter_js");
    var linkText = document.querySelector(".catalogCardsAlphabetTextChecked_js");
    var btnAll = document.querySelector(".catalogCardsAlphabetAll_js");
...
function sliderMasterClass() {
  ...
  var sliderNav = $(".masterClass__sliderNav_js");
...
function specialSampleTabs() {
  if (document.querySelector('.productSpecial_js')) {
...
function masterClassPopups() {
  if (document.querySelector(".masterArchive__popup_js")) {
    ...
    var btnApplyPopup = masterPopup.querySelector(".masterArchive__apply_js");
    ...
    inputsItems.forEach(function (item) {
      item.onclick = function () {
        masterItems.forEach(function (el) {
          if (el.contains(item)) {
            el.classList.toggle("masterArchive__item_open");
...
function masterClassBuy() {
  if (document.querySelector(".masterClassOrder_js")) {
    var masterBuyBtn = document.querySelectorAll(".masterClass__btn_js");
    var masterBuyWrapper = document.querySelector(".masterClassWrapper_js");
    ...
    masterBuyWrapper.onclick = function (e) {
      if (masterBuyPopup && e.target !== masterBuyPopup && !masterBuyPopup.contains(e.target)) {
        masterBuyWrapper.classList.add("hidden");
        document.body.classList.remove("hiddenHeaderCatalog");
      }
    };

    masterBuyClose.onclick = function () {
      masterBuyWrapper.classList.add("hidden");
      document.body.classList.remove("hiddenHeaderCatalog");
    };

    masterBuyOrder.onclick = function () {
      masterBuyWrapper.classList.add("hidden");
      document.body.classList.remove("hiddenHeaderCatalog");
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "masterClassShow", function() { return masterClassShow; });
...
function masterClassShow() {
  if (document.querySelector(".masterClassCard__body_js")) {
    var buttonMaster = document.querySelectorAll(".masterClassCard__readAll_js");
    var bodyMaster = document.querySelectorAll(".masterClassCard__body_js");
    buttonMaster.forEach(function (item) {
      item.onclick = function () {
        bodyMaster.forEach(function (el) {
          if (el.contains(item)) {
...
function newspaperPopup() {
  if (document.querySelector(".newspaperHeader__last_js")) {
    ...
    var archive = document.querySelector(".newspaperHeader__archive_js");
    var archiveYearBtn = archive.querySelector(".newspaperHeader__btn");
    var archiveYear = archive.querySelector(".newspaperHeader__btn_year");
    var archivePopup = archive.querySelector(".newspaperHeader__years_js");
    var archiveYearClick = archive.querySelectorAll(".newspaperHeader__year_js");
    ...
    document.onclick = function (e) {
      if (archivePopup && e.target !== archivePopup && e.target !== archiveYearBtn && e.target !== archiveYear && !archivePopup.contains(e.target)) {
        archive.classList.remove("newspaperHeader__item_open");
      }
    };

    archiveYearClick.forEach(function (item) {
      item.onclick = function () {
...
function articles() {
  $(".helpfulCard__btn").each(function (item, i) {
    $(i).hover(function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newsCategories", function() { return newsCategories; });
function newsCategories() {
  if (document.querySelector(".news__allnews_js")) {
    var news = document.querySelector(".news");
    var btnAllNews = news.querySelector(".newsHeader__all_js");
    var btnMasterClass = news.querySelector(".newsHeader__master_js");
    var containerAll = news.querySelector(".news__allnews_js");
    var containerMaster = news.querySelector(".news__master_js");

    btnAllNews.onclick = function () {
    ...
    btnMasterClass.onclick = function () {
...
FLIPBOOK.Book3 = function (t, e, i) {
  ...
  e.on("toolMove", function () {
    ...
    if (isNaN(o.scroll.scale)) o.zoomTo(i.zoomMin);else {
  ...
  for (var r = 0; r < i.pages.length; r++) {
    (n = new FLIPBOOK.Page3(this, r, i.pages[r].src, i.pages[r].htmlContent)).hideHtml(), this.pagesArr.push(n), this.$centerContainer.append(n.$wrapper), this.flippedright++;
  }
  ...
  for (var e = this, i = FLIPBOOK.IScroll.utils.style.transform, o = 0; o < this.pagesArr.length; o++) {
    o == this.flippedleft ? this.pagesArr[o].show() : o != this.flippedleft - 1 || this.options.singlePageMode ? this.pagesArr[o].hide() : this.pagesArr[o].show(), this.pagesArr[o]._setZIndex(0), this.pagesArr[o]._setStyle(this.pagesArr[o].wrapper.style, i, "");
  }
  ...
  if (this.nextEnabled) if (1 != this.view || !this.isFocusedLeft() || this.options.singlePageMode) this.goToPage(this.rightIndex + 2);else {
    var t = 700 * this.options.pageFlipDuration / 2;
    this.focusRight(t);
  }
}, FLIPBOOK.Book3.prototype.prevPage = function () {
  if (this.prevEnabled) if (1 != this.view || !this.isFocusedRight() || this.options.singlePageMode) {
  ...
  if (this.enabled && !this.flipping) if (!this.options.singlePageMode && t % 2 == 0 || t--, t < 0 && (t = 0), t > this.pagesArr.length && (t = this.pagesArr.length), t != this.rightIndex) {
  ...
  var e, i, o, s;
  if (this.angle = t, this.hideHtml(), this.options.singlePageMode) 0 < t ? ((o = this.pagesArr[this.rightIndex])._setAngle(t / 2), (i = this.pagesArr[this.goingToPage]) && i.show()) : ((s = this.pagesArr[this.goingToPage]).show(), s._setAngle(t / 2 + 90), o = this.pagesArr[this.rightIndex]);else if (0 < t) {
  ...
  setMat: function setMat(t, e, i) {},
  hideHtml: function hideHtml() {
  ...
  setDataUrl: function setDataUrl(t, e) {
    var i = this;
  ...
  _setAngle: function _setAngle(t) {
    if (this.angle != t) {
      this.angle = t;
      var e,
          i,
      ...
      for (i = 0; i < this.book.pagesArr.length; i++) {
        i != this.index && this.book.pagesArr[i].zIndex > n && (n = this.book.pagesArr[i].zIndex);
      }

      this._setZIndex(n + 1);
    }
  },
  _setZIndex: function _setZIndex(t) {
    this.zIndex != t && (this.wrapper.style["z-index"] = t), this.zIndex = t;
  },
  _setStyle: function _setStyle(t, e, i) {
    t && (t[e] = i);
  }
};
...
!function (M, L, C, a) {
  M.fn.flipBook = function (e) {
    ...
    var u,
        ...
        w,
        P = this.options;
    if (P.isMobile = M.browser.mobile || l || r, P.isMobile) for (var c in P.mobile) {
      P[c] = P.mobile[c];
    }
    if (this.strings = P.strings, P.pageShininess = P.pageShininess / 2, this.s = 0, P.googleAnalyticsTrackingCode && (this.gaCode = P.googleAnalyticsTrackingCode, L.ga || (g = C, f = "script", b = "ga", (u = L).GoogleAnalyticsObject = b, u.ga = u.ga || function () {
      ...
      if (S) {
        for ("string" == typeof S && (S = S.split(",")), i = 0; i < S.length; i++) {
          S[i] = Number(S[i]);
        }
    ...
    loadPageHTML: function loadPageHTML(t, o) {
    ...
    createBook: function createBook() {
      ...
      if (this.options.numPages = this.options.pages.length, this.options.numPages % 2 == 0 || this.options.singlePageMode || (this.oddPages = !0, this.options.oddPages = !0, this.options.pages.push({
        ...
        void 0 !== n.options.pages[i].htmlContent && (n.options.hasHtmlContent = !0, n.options.pages[i].htmlContent = M(n.options.pages[i].htmlContent));
      }
  ...
  (jQuery.browser = jQuery.browser || {}).mobile = /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(e) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(e.substr(0, 4));
   ...
   true && __webpack_require__(26).jQuery ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : e( true && module.exports ? __webpack_require__(2) : jQuery);
}(function (re) {
  "use strict";
  ...
  function i(e, r) {
      ...
      if (X !== ye && X !== Me && !x()) {
        ...
        if (te = E(), i && (G = i.length), r.hold && clearTimeout(ae), X = Oe, 2 == G && (0 == V ? (O(1, i[1]), V = W = I(J[0].start, J[1].start)) : (y(i[1]), W = I(J[0].end, J[1].end), J[0].end, J[1].end, Z = U < 1 ? ue : ce), U = function (e, t) {
          ...
          if (N = F(n.start, n.end), function (e, t) {
            if (!1 !== r.preventDefaultEvents) if (r.allowPageScroll === ge) e.preventDefault();else {
    ...
    this.enable = function () {
      ...
      if ("object" == _typeof(e)) r = re.extend(r, e);else if (void 0 !== r[e]) {
...
FLIPBOOK.PdfService = function (i, e, u) {
  ...
  this.pdfDocument = i, this.pdfInfo = i._pdfInfo, this.numPages = this.pdfInfo.numPages, this.webgl = "webgl" == u.viewMode, this.options = u, this.main = u.main, this.model = e, this.pages = [], this.thumbs = [], this.canvasBuffer = [], this.viewports = [], this.textContents = [], this.pdfPages = [], this.pdfAnnotations = [], this.eventBus = new EventBus(), this.linkService = new PDFLinkService({
    ...
    this.getViewport(s, function (e) {
      var t = h.pages[s];
      if (t.thumb) l.call(h, t.thumb);else {
    ...
    if (e >= this.pdfInfo.numPages && r.call(o), this.pages[e]) {
      if (s.htmlContent || (s.htmlContent = document.createElement("div"), s.htmlContent.classList.add("flipbook-page-htmlContent")), s.textContent) {
        ...
        if (u.doublePage) {
          if (0 == n) l(t, n);else if (n == u.pages.length / 2) l(t, u.numPages - 1);else {
    ...
    if (e.canvas && e.canvas[t]) {
      ...
      if (a.pdfPageIndex = r, u.doublePage) {
        if (0 == r) a.pageIndex = 0, a.rendering = !1, a.rendered = !0, i.onBookPageRendered(e, a, 0, t);else if (r == u.pages.length / 2) a.pageIndex = u.numPages - 1, a.rendering = !1, a.rendered = !0, i.onBookPageRendered(e, a, u.numPages - 1, t);else if (i.webgl) a["double"] = !0, a.scaleX = a.width / 2 / t, a.scaleY = a.scaleY, a.pageIndex = 2 * r, a.rendering = !1, a.rendered = !0, i.onBookPageRendered(e, a, 2 * r, t), i.onBookPageRendered(e, a, 2 * r - 1, t);else {
    ...
    value: function value(e, t) {
      ...
      if (this._dispatchToDOM) {
        ...
        if (n && 0 < n.length) {
          ...
          for (var r in a) {
            var s = a[r];
            if ("source" !== r) i[r] = s;else if (s === window || s === document) return;
          }
        }
  ...
  return _createClass(h, [{
    ...
    value: function value(e, t) {
      ...
      for (var l = 0, h = e.length; l < h; l++) {
        for (var d = e[l]; n !== r && d >= i + a[n].length;) {
          i += a[n].length, n++;
        }
        ...
        for (d += t ? t[l] : s; n !== r && d > i + a[n].length;) {
          i += a[n].length, n++;
        }
      ...
      if (0 !== e.length) {
        var l = this.textContentItemsStr,
          ...
          offset: void 0
            ...
            s = a,
            o = s + 1;
        if (null !== this.findController && this.findController.state.highlightAll) s = 0, o = e.length;else if (!i) return;
        ...
        for (var d = s; d < o; d++) {
          ...
          if (t && u.divIdx === t.divIdx ? y(t.divIdx, t.offset, u.offset) : (null !== t && y(t.divIdx, t.offset, r.offset), m(u)), u.divIdx === g.divIdx) y(u.divIdx, u.offset, g.offset, "highlight" + f);else {
            y(u.divIdx, u.offset, r.offset, "highlight begin" + f);

            for (var p = u.divIdx + 1, x = g.divIdx; p < x; p++) {
              h[p].className = "highlight middle" + f;
            }
    ...
    value: function value() {
      ...
      a.pageCancelled = function (e) {
        if (e.pageNumber === n.pageNumber) if (n.textLayerRenderTask) console.error("TextLayerBuilder._bindEvents: `this.cancel()` should have been called when the page was reset, or rendering cancelled.");else for (var t in a) {
          i.off(t.toLowerCase(), a[t]), delete a[t];
        }
    ...
    value: function value(n, e) {
      ...
      this.pdfPage.getAnnotations({
        ...
        if (!i._cancelled) {
          ...
          if (i.div) pdfjsLib.AnnotationLayer.update(t);else {
...
FLIPBOOK.BookSwipe = function (i, e, s, t) {
  ...
  for (t.rightToLeft, t.numPages, t.pdfMode, o = 0; o < t.numPages; o++) {
    n = new FLIPBOOK.PageSwipe(s, t, o, t.pages[o].src, t.pages[o].htmlContent), this.pagesArr.push(n), t.loadAllPages && n.load();
  }
...
}, FLIPBOOK.BookSwipe.prototype.constructor = FLIPBOOK.BookSwipe, FLIPBOOK.BookSwipe.prototype = (_FLIPBOOK$BookSwipe$p = {
  goToPage: function goToPage(i, e) {
  ...
  setRightIndex: function setRightIndex(i) {
    this.rightIndex = i;
  },
  nextPage: function nextPage(i) {
    2 != this.currentSlide && (this.flipping = !0, this.goToSlide(this.currentSlide + 1, i));
  },
  prevPage: function prevPage(i) {
    0 != this.currentSlide && (this.flipping = !0, this.goToSlide(this.currentSlide - 1, i));
  },
  enablePrev: function enablePrev(i) {
    this.prevEnabled = i;
  },
  enableNext: function enableNext(i) {
    this.nextEnabled = i;
  },
  resetZoom: function resetZoom() {},
  setSlidePages: function setSlidePages(i, e) {
  ...
  clearSlidePages: function clearSlidePages(i) {
    this.slides[i].find(".slide-inner").empty(), this.slides[i].pages = [];
  },
  setZoomPages: function setZoomPages(i) {
  ...
  resizeZoomPages: function resizeZoomPages(i, e) {
  ...
  getCurrentSlidePages: function getCurrentSlidePages() {
    return this.singlePage ? [this.rightIndex] : [this.rightIndex - 1, this.rightIndex];
  },
  clearSlide: function clearSlide(i) {
    this.slides[i].empty();
  },
  hasPage: function hasPage(i, e) {},
  loadVisiblePages: function loadVisiblePages() {
  ...
  onResize: function onResize() {
    ...
    if (this.w = i, this.h = e, 0 != i && 0 != e) {
      ...
      for (var r = 0; r < this.slides.length; r++) {
        this.slides[r].width(i + 0).height(e), this.slides[r].iscroll && (this.slides[r].iscroll.options.zoomMin = this.options.zoomMin * s, this.slides[r].iscroll.options.zoomMax = this.options.zoomMax * s, this.slides[r].iscroll.refresh());
      }
  ...
  resizeInnerSlides: function resizeInnerSlides() {
    ...
    for (var e = this.singlePage ? i : 2 * i, s = 0; s < 3; s++) {
      e = this.slides[s].pages && 1 == this.slides[s].pages.length ? i : 2 * i, this.slides[s].find(".slide-inner").width(e);
    }
  },
  resizeInnerSlide: function resizeInnerSlide(i) {
  ...
  goToSlide: function goToSlide(i, e) {
  ...
  zoomIn: function zoomIn(i, e, s) {
    s && "mousewheel" === s.type || this.zoomTo(i);
  },
  zoomTo: function zoomTo(i, e, s, t) {
    if (this.enabled) {
      s = s || 0, t = t || 0, e = e || 0;
  ...
  zoomOut: function zoomOut(i) {
    this.zoomTo(i);
  },
  onZoom: function onZoom(i) {
  ...
  enableAutoplay: function enableAutoplay(i) {},
  updateCurrentPage: function updateCurrentPage(i) {}
}, _defineProperty(_FLIPBOOK$BookSwipe$p, "enable", function enable() {
  this.enabled = !0;
}), _defineProperty(_FLIPBOOK$BookSwipe$p, "disable", function disable() {
  this.enabled = !1;
}), _defineProperty(_FLIPBOOK$BookSwipe$p, "onSwipe", function onSwipe(i, e, s, t, o, h, n) {}), _defineProperty(_FLIPBOOK$BookSwipe$p, "onPageUnloaded", function onPageUnloaded(i, e) {
  var s = this.options.rightToLeft ? this.options.numPages - i - 1 : i;
  this.pagesArr[s].unload();
}), _defineProperty(_FLIPBOOK$BookSwipe$p, "disableFlip", function disableFlip() {
  this.flipEnabled = !1, this.iscroll.disable();
}), _defineProperty(_FLIPBOOK$BookSwipe$p, "enableFlip", function enableFlip() {
  1 != this.options.numPages ? (this.flipEnabled = !0, this.iscroll.enable()) : this.disableFlip();
}), _defineProperty(_FLIPBOOK$BookSwipe$p, "enablePan", function enablePan() {
...
}), _defineProperty(_FLIPBOOK$BookSwipe$p, "disablePan", function disablePan() {
...
}), _FLIPBOOK$BookSwipe$p), FLIPBOOK.PageSwipe = function (i, e, s, t, o) {
  ...
  setRotation: function setRotation(i) {
  ...
  updateHtmlContent: function updateHtmlContent() {
    var i = this.ph / 1e3,
        e = this.htmlContent;
