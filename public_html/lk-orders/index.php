		...
		<section class="page__box">
			<div class="lk">
				...
				<section class="lk__content">
					...
					<div class="lkOrders__zeroOrders hidden">
						...
						<div class="lkOrders__item">
								...
								<div class="basket__card basketCard lkOrders__card">
									<div class="lkOrders__boxCard">
										...
										<div class="basketCard__description">
											<div class="basketCard__title basketCard__title_orders">Ель обыкновенная Инверса на штамбе</div>
							...
							<div class="lkOrders__info">
								<div class="lkOrders__box">
									...
									<div class="lkOrders__text">Сумма:
						...
						<div class="lkOrders__item">
							...
							<div class="lkOrders__info">
								<div class="lkOrders__box">
									...
									<div class="lkOrders__text">Сумма: <span class="lkOrders__sum">&nbsp; 13 800</span> <span class="basketCard__ruble"> ₽</span></div>
								</div>
								<div class="lkOrders__text lkOrders__text_margin"> Адрес доставки:</div>
								<div class="lkOrders__address"><span>г. Омск ул. Сакена Сейфуллина, 27</span></div>
							</div>
							...
							<div class="lkOrders__cards">
								...
								<div class="basket__card basketCard lkOrders__card">
									...
									<div class="basketCard__action">
										...
										<div class="basketCard__price basketCard__price_width">
											<span class="basketCard__priceValue basketCard__priceValue_orders">2 880</span>
											<span class="basketCard__priceValue basketCard__ruble basketCard__ruble_orders basketCard__priceValue_orders">₽</span>
										</div>
									</div>
								</div>
							</div>
